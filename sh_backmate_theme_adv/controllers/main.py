...
#
    ...
    def update_theme_color(self, primary_color_id, primary_hover_id, primary_active_id, gradient_color, secondary_color_id, secondary_hover_id, secondary_active_id,
                           ...
                           tab_style, tab_style_mobile, horizontal_tab_style, vertical_tab_style, form_element_style, search_style, breadcrumb_style,chatter_position,loading_style,progress_style,progress_height,progress_color,checkbox_style,radio_btn_style,scrollbar_style):
        theme_setting_rec = request.env['sh.back.theme.config.settings'].sudo().search([
            ('id', '=', 1)], limit=1)
        is_used_google_font = False
